      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Data SPP</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                ...
                <a href="tambah_spp.php"> <i class="tim-icons icon-simple-add"></i> Tambah SPP</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                       <?php
                         ...
                         <tr class="text-center">
                            ...
                            <td>
                                <a href="edit_spp.php?id=<?php echo $row['id_spp']; ?>"><i class="tim-icons icon-settings"></i></a> |
                                <a href="proses_hapusspp.php?id=<?php echo $row['id_spp']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="tim-icons icon-trash-simple"></i></a>
                            </td>
                        </tr>
