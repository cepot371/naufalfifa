      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Tambah Pengguna</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Tambah Pengguna</h5>
              </div>
              <div class="card-body">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="form-group">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nama_pengguna" autofocus="" required="" />
                      </div>
                    </div>
                    <div class="form-group">           
                      <label>Level</label>
            ...
            <?php
                ...
                {
                ?>
           <option class="bg-dark" value="<?php echo $row['id_petugas']; ?>"><?php echo $row['level']; ?></option>
           <?php
