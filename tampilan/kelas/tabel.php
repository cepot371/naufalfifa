      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Data Kelas</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                ...
                <a href="tambah_kelas.php"> <i class="tim-icons icon-simple-add"></i> Tambah Kelas</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                       <?php
                         ...
                         <tr class="text-center">
                            ...
                            <td>
                                <a href="edit_kelas.php?id=<?php echo $row['id_kelas']; ?>"><i class="tim-icons icon-settings"></i></a> |
                                <a href="proses_hapuskelas.php?id=<?php echo $row['id_kelas']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="tim-icons icon-trash-simple"></i></a>
                            </td>
                        </tr>
