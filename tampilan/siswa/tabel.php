          ...
          <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                ...
                <a href="tambah_siswa.php"> <i class="tim-icons icon-simple-add"></i> Tambah Siswa</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      <?php
                         ...
                         <tr class="text-center">
                            ...
                            <td>
                                <a href="edit_siswa.php?id=<?php echo $row['nisn']; ?>"><i class="tim-icons icon-settings"></i></a> |
                                <a href="proses_hapussiswa.php?id=<?php echo $row['nisn']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="tim-icons icon-trash-simple"></i></a>
                            </td>
                        </tr>
