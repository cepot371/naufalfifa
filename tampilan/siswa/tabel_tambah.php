      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Tambah Siswa</a>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nisn" autofocus=""  />
                      </div>
                    </div>
                       <div class="form-group">
                        <label>NIS</label>
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nis" autofocus="" />
                      </div>
                    </div>
                     <div class="form-group">
