          ...
          <div class="col-md-12">
            <div class="card  card-plain">
              <div class="card-header">
                ...
                <a href="tambah_pembayaran.php"> <i class="tim-icons icon-simple-add"></i> Tambah Pembayaran</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      <?php
                         ...
                         <tr class="text-center">
                            ...
                            <td>
                                <a href="edit_pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>"><i class="tim-icons icon-settings"></i></a> |
                                <a href="proses_hapuspembayaran.php?id=<?php echo $row['id_pembayaran']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="tim-icons icon-trash-simple"></i></a>
                            </td>
                        </tr>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Transaksi Pembayaran</a>
          </div>
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-bar navbar-kebab"></span>
            <span class="navbar-toggler-bar navbar-kebab"></span>
                    ...
                    <tbody>
                      <?php
                          // jalankan query untuk menampilkan semua data diurutkan berdasarkan id
                            ...
                            if (isset($_POST['kata_kunci'])) {
                                $kata_kunci=trim($_POST['kata_kunci']);
                                $query="select * from pembayaran,petugas,spp where pembayaran.id_petugas=petugas.id_petugas and pembayaran.id_spp=spp.id_spp and pembayaran.tahun_dibayar like '%".$kata_kunci."%' order by bulan_dibayar asc";
